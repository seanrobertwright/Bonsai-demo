...
class AgentLoop:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "- **remember**: Use sparingly. Most turns should NOT save anything. ONLY when "
            "the user has just shared a durable fact about themselves (location, job, family, "
            "a long-running project, a preference for how you behave) that isn't already in "
            "'Things you know about the user'. NEVER for trivia, passing remarks, or facts "
            "about topics the user asked about. Save at most one fact per turn. When in doubt, "
            "don't save.\n\n"
